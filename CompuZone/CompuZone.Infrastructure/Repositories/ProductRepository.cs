...
namespace CompuZone.Infrastructure.Repositories
{
    public class ProductRepository : GenericRepository<Product> ,IProductRepository 
    {
        ...
        {
            var product = _dbContext.Products.SingleOrDefault(a => a.ID == id);
        ...
        {
            return _dbContext.Products.Include(a => a.Category);
        }

        public async Task<Product> GetByIDWithCategoryAsync(int id)
        {
            return await _dbContext.Products.Include(a => a.Category).SingleOrDefaultAsync(a => a.ID == id);
        }
