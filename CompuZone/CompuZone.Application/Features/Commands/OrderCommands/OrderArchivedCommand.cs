...
{
    public class OrderArchivedCommand : IRequest<bool>
    {
        public int ID { get; set; }
    }
    public class OrderArchivedCommandHandler : IRequestHandler<OrderArchivedCommand, bool>
    {
        ...
        public OrderArchivedCommandHandler(IGenericRepository<Order> repository, IMapper mapper
        ...
        public async Task<bool> Handle(OrderArchivedCommand request, CancellationToken cancellationToken)
        {
            ...
            _repository.ArchivedAsync(Order);
